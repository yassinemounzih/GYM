                                ...
                                <form action="{{ route('client.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" name="dateD" value="{{ old('dateD') }}" class="form-control" >
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4"><b>Assurance</b></label>
                                              <div class="col-sm-6">
                                                <div class="row">
                                                  <div class="col-sm-4">
                                                    <label class="radio-inline">
                                                      <input type="radio"  value="Oui" name="asrn" class="form-control" required><b>Oui</b>
                                                    </label>
                                                  </div>
                                                <div class="col-sm-4">
                                                  <label class="radio-inline">
                                                    <input type="radio"  value="Non" name="asrn" class="form-control" ><b>Non<b>
                                                  </label>
                                            ...
                                            <label class="control-label col-sm-4"><b>Payment</b></label>
                                              <div class="col-sm-6">
                                                <div class="row">
                                                  <div class="col-sm-4">
                                                    <label class="radio-inline">
                                                      <input type="radio"  value="Oui" name="pay" class="form-control" required><b>Oui</b>
                                                    </label>
                                                  </div>
                                                <div class="col-sm-4">
                                                  <label class="radio-inline">
                                                    <input type="radio"  value="Non" name="pay" class="form-control" ><b>Non<b>
                                                  </label>
