                                ...
                                <div class="card-body">
                                    <form action="{{ route('client.update', [$client->id]) }}" method="Post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" name="dateD" value="{{old('time')?? date('Y-m-d\TH:i', strtotime($client->dateDubet)) }}"" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-8">
                                                ...
                                                <div class="row">
                                                  <div class="col-sm-4">
                                                    <label class="radio-inline">
                                                      <input type="radio"  value="Oui" name="asrn" {{ $client->asrn == 'Oui' ? 'checked' : '' }} class="form-control" required  ><b>Oui</b>
                                                    </label>
                                                  </div>
                                                <div class="col-sm-4">
                                                  <label class="radio-inline">
                                                    <input type="radio"  value="Non" name="asrn" class="form-control" {{ $client->asrn == 'Non' ? 'checked' : '' }} ><b>Non<b>
                                                  </label>
