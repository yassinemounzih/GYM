...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Clients Liste</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('abonnement.create') }}" class="btn btn-primary">Ajoute Client</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body ">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @if($abonnementsP->count())
                                @foreach ($abonnementsP as $abonnement)
                                    <tr>
                                        <td>{{ $abonnement->id }}</td>
                                        <td>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <a href="#" class="btn btn-sm btn-primary mr-1 btn btn-info edit"  data-toggle="modal" data-target="#modal-info"> <i class="fas fa-edit"></i> </a>
     ...
     <div class="modal fade" id="modal-info">
        <div class="modal-dialog">
          <div class="modal-content bg-info">
            ...
            <form action="{{route('abonnement.update' , [$abonnement->id])}}" id="ed_a" method="POST" enctype="multipart/form-data" >
                @csrf 
                @method('PUT')
